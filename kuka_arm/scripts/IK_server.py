...
def handle_calculate_IK(req):
    ...
    if len(req.poses) < 1:
        ...
        q1, q2, q3, q4, q5, q6, q7 = symbols('d1:8')  # theta 1
        d1, d2, d3, d4, d5, d6, d7 = symbols('d1:8')  # link offset
        a0, a1, a2, a3, a4, a5, a6 = symbols('a0:7')  # l ink length
        ...
        T6_EE = transformation_matrix(alpha6, a6, d7, q7).subs(s)
        ...
        for x in xrange(0, len(req.poses)):
            ...
            # Compensate for rotation discrepancy between DH parameters and Gazebo
            Rot_Error = ROT_z.subs(y, radians(180)) * \
                ROT_y.subs(p, radians(-90))
            ...
            side_a = 1.501
            side_b = sqrt(
                pow((sqrt(WC[0] * WC[0] + WC[1] * WC[1]) - 0.35), 2) + pow((WC[2] - 0.75), 2))
            side_c = 1.25
            ...
            theta5 = atan2(
                sqrt(R3_6[0, 2] * R3_6[0, 2] + R3_6[2, 2] * R3_6[2, 2]), R3_6[1, 2])
